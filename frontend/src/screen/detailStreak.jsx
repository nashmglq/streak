      ...
      <div className="container mx-auto my-auto">
        <div className="flex flex-wrap justify-center items-center h-screen">
          <div className="flex flex-col items-center justify-center w-3/4 sm:w-1/4 bg-white shadow-lg h-1/2 sm:h-auto rounded-lg border-2 p-4">
            ...
            <button className="mt-8 p-4 rounded-lg shadow-lg bg-yellow-200 font-bold text-neutral-800 transition-all duration-300 hover:scale-110 hover:bg-yellow-300 w-full sm:w-auto">
              ⚡Streak⚡
            </button>
          </div>
        </div>
